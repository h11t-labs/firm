...
seal signed by a key it does not hold as a seal key, it hard-fails and names the likely cause:
*"seal key missing from keyring — is this a two-key deployment?"*.
